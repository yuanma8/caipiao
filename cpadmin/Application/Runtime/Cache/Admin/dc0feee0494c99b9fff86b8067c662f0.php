            ...
            <div class="pull-left width-50">
                ...
                <!-- /section:basics/sidebar.options -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" action="<?php echo U('qrcodesave');?>" method="post">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 支付用户 </label>
                                    <div class="col-sm-9">
                                        <input type="text"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label no-padding-right" for="form-field-4"> 支付二维码 </label>
                                    <div class="col-sm-9">
                                        <div class="col-xs-10 col-sm-5"><?php echo UpImage("qrcodepic",300,300,$payment['qrcodepic']);?></div>
                                        <span class="help-inline col-xs-12 col-sm-7">
