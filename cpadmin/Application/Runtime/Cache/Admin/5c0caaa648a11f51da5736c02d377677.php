                        ...
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" action="<?php echo U('update');?>" method="post">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text"
                                        <?php if($user['uid'] == 1): ?>readonly
                                            <?php else: ?>
                                            name="username"<?php endif; ?>
                                        class="rcol-xs-10 col-sm-5" value="<?php echo ($user["username"]); ?>">
                                        <input type="hidden" name="uid" value="<?php echo ($user['uid']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <?php if($user['uid'] == 1): ?><span class="middle">无法修改</span><?php endif; ?>
                                        </span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="dan" class="form-control">
                                            <option <?php if($user['botactive'] == 0): ?>selected<?php endif; ?> value="0">100档（试用）</option>
                                            <option <?php if($user['botactive'] == 1): ?>selected<?php endif; ?> value="1">500档</option>
                                            <option <?php if($user['botactive'] == 2): ?>selected<?php endif; ?> value="2">1000档</option>
                                            <option <?php if($user['botactive'] == 3): ?>selected<?php endif; ?> value="3">2000档</option>
                                            <option <?php if($user['botactive'] == 4): ?>selected<?php endif; ?> value="4">5000档</option>
                                            <option <?php if($user['botactive'] == 5): ?>selected<?php endif; ?> value="5">10000档</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="space-4"></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <select name="botonline" class="form-control">
                                            <option value="1" <?php if($user['botonline'] == 1): ?>selected="selected"<?php endif; ?> >可用</option>
                                            <option value="0" <?php if($user['botonline'] == 0): ?>selected="selected"<?php endif; ?> >强制下线</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <select id="sex" name="sex" class="multiselect">
                                            <option value="0"
                                            <?php if($user['sex'] == 0): ?>selected="selected"<?php endif; ?>
                                            >保密</option>
                                            <option value="1"
                                            <?php if($user['sex'] == 1): ?>selected="selected"<?php endif; ?>
                                            >男</option>
                                            <option value="2"
                                            <?php if($user['sex'] == 2): ?>selected="selected"<?php endif; ?>
                                            >女</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="col-xs-10 col-sm-5"><?php echo UpImage("headPhoto",100,100,$user['headPhoto']);?></div>
                                        <span class="help-inline col-xs-12 col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9 col-sm-9">
                                        <div class="input-group col-xs-5">
                                            ...
                                            <input class="form-control" id="birthday" name="birthday" value="<?php if( $member['birthday'] != '' ): echo (date("Y-m-d",$user['birthday'])); endif; ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="phone" id="phone" placeholder="联系电话"
                                            class="col-xs-10 col-sm-5" value="<?php echo ($user['phone']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="totalmoney" id="totalmoney" placeholder="账户金额"
                                            class="col-xs-10 col-sm-5" value="<?php echo ($user['totalmoney']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <span class="middle"></span>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="freezemoney" id="freezemoney" placeholder="冻结金额"
                                            class="col-xs-10 col-sm-5" value="<?php echo ($user['freezemoney']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <span class="middle"></span>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="agent" id="agent" placeholder=" 所属代理 "
                                            class="col-xs-10 col-sm-5" value="<?php echo ($user['agent']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <span class="middle"></span>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" name="percentage" id="percentage" placeholder="收益率" class="col-xs-10 col-sm-5"
                                            value="<?php echo ($user['percentage']); ?>">   %
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <span class="middle"></span>
                                        </span>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="email" name="email" id="email" placeholder="E-mail"
                                            class="col-xs-10 col-sm-5" value="<?php echo ($user['email']); ?>">
                                        <span class="help-inline col-xs-12 col-sm-7">
                                            <span class="middle"></span>
                                        </span>
                                    </div>
...
<script src="/Public/admin/js/jquery-ui.js"></script>
    ...
    <script src="/Public/admin/js/date-time/bootstrap-datepicker.js"></script>
