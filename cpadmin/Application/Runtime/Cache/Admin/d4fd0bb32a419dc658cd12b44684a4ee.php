            ...
            <div class="pull-left width-50">
                ...
                <!-- /section:basics/sidebar.options -->
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <!-- PAGE CONTENT BEGINS -->
                            <form class="form-horizontal" action="<?php echo U('withdrawupdate');?>" method="post">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label no-padding-right" for="form-field-1"> 用户名 </label>
                                    <div class="col-sm-9">
                                        <input type="text"
                                        <?php if($moneydetails['id'] == 1): ?>readonly
                                            <?php else: ?>
                                            name="username"<?php endif; ?>
                                        class="rcol-xs-10 col-sm-5" value="<?php echo ($moneydetails["username"]); ?>">
