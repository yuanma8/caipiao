            ...
            <div class="pull-left width-50">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <div class="row">
                            <form class="form-inline" action="" method="get">
                                ...
                                <select name="field" class="form-control">
                                    <option <?php if(I('field') == username): ?>selected<?php endif; ?> value="username">用户名</option>
                                ...
                                <select name="order" class="form-control">
                                    <option <?php if(I('order') == asc): ?>selected<?php endif; ?> value="asc">订单时间升</option>
                                    <option <?php if(I('order') == desc): ?>selected<?php endif; ?> value="desc">订单时间降</option>
                                </select>
                        ...
                        <div class="row">
                            <form id="form" method="post" action="<?php echo U('withdrawdel');?>">
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td class="center">
                                               <?php echo ($val['moneystr']); ?>            </td>
                                            <td class="center"><?php echo ($val['createdtime']); ?></td>
                                            <td class="center"><?php echo (date("Y-m-d",$val['birthday'])); ?></td>
                                            <td><?php echo ($val['phone']); ?></td>
                                            <td><?php echo ($val['qq']); ?></td>
                                            <td><?php echo ($val['totalmoney']); ?></td>
                                            <td class="center"><a href="<?php echo U('withdrawedit',array('id'=>$val['id']));?>">修改</a>&nbsp;
                                                <?php if($val['id'] != 1): ?><a class="del" href="javascript:;"
                                                                                     val="<?php echo U('withdrawdel',array('id'=>$val['id']));?>"
