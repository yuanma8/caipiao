        ...
        if(IS_POST)
        {
            ...
            if ($user) {
               ...
               session('uid',$user['uid']);
                ...
                echo json_encode(array('msg'=>$_SESSION['uid'],'IsSuccess'=>true,'StatusCode'=>'0'));
                addlog('登录成功。');
              
                exit(0);
            } else {
                addlog('登录失败。', $username);
               echo json_encode(array('msg'=>'Some errors occured.','IsSuccess'=>true,'StatusCode'=>'0'));
            }
